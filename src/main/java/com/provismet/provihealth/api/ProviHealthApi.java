...
public interface ProviHealthApi {
     ...
     */
    public default void registerIcon (EntityGroup entityGroup, Item item) {
        BorderRegistry.registerItem(entityGroup, item);
    }
     ...
     */
    public default void registerPortrait (EntityGroup entityGroup, Identifier resource) {
        BorderRegistry.registerBorder(entityGroup, resource);
    }
