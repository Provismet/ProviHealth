...
public interface IMixinEntityRenderState {
    ...
    void provi_Health$setTitles (List<Component> titles);
    void provi_Health$setShouldRenderLabel (boolean value);
    void provi_Health$setLabel (Component label);
    ...
    List<Component> provi_Health$getTitles ();
    boolean provi_Health$shouldRenderLabel ();
    Component provi_Health$getLabel ();
